...
bool microstrain_inertial_msgs__msg__mip_gps_timestamp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.msg._mip_gps_timestamp.MipGpsTimestamp", full_classname_dest, 64) == 0);
  }
  microstrain_inertial_msgs__msg__MipGpsTimestamp * ros_message = _ros_message;
  {  // tow
  ...
  {  // valid_flags
    ...
    if (!microstrain_inertial_msgs__msg__mip_gps_timestamp_valid_flags__convert_from_py(field, &ros_message->valid_flags)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of MipGpsTimestamp */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.msg._mip_gps_timestamp");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MipGpsTimestamp");
  ...
  {  // valid_flags
    PyObject * field = NULL;
    field = microstrain_inertial_msgs__msg__mip_gps_timestamp_valid_flags__convert_to_py(&ros_message->valid_flags);
    if (!field) {
      return NULL;
    }
    {
