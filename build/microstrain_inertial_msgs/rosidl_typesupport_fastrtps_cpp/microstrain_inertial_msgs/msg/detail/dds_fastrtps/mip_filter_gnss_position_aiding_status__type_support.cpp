...
#include "microstrain_inertial_msgs/msg/detail/mip_filter_gnss_position_aiding_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const microstrain_inertial_msgs::msg::MipFilterGnssPositionAidingStatusStatus &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const microstrain_inertial_msgs::msg::MipFilterGnssPositionAidingStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  microstrain_inertial_msgs::msg::MipFilterGnssPositionAidingStatus & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_microstrain_inertial_msgs
max_serialized_size_MipFilterGnssPositionAidingStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        microstrain_inertial_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MipFilterGnssPositionAidingStatusStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = microstrain_inertial_msgs::msg::MipFilterGnssPositionAidingStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const microstrain_inertial_msgs::msg::MipFilterGnssPositionAidingStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<microstrain_inertial_msgs::msg::MipFilterGnssPositionAidingStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MipFilterGnssPositionAidingStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const microstrain_inertial_msgs::msg::MipFilterGnssPositionAidingStatus *>(
...
static size_t _MipFilterGnssPositionAidingStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MipFilterGnssPositionAidingStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MipFilterGnssPositionAidingStatus__callbacks = {
...
static rosidl_message_type_support_t _MipFilterGnssPositionAidingStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MipFilterGnssPositionAidingStatus__callbacks,
...
{
  return &microstrain_inertial_msgs::msg::typesupport_fastrtps_cpp::_MipFilterGnssPositionAidingStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, microstrain_inertial_msgs, msg, MipFilterGnssPositionAidingStatus)() {
  return &microstrain_inertial_msgs::msg::typesupport_fastrtps_cpp::_MipFilterGnssPositionAidingStatus__handle;
}
