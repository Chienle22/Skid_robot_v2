...
// Member `valid_flags`
#include "microstrain_inertial_msgs/msg/mip_gps_timestamp_valid_flags.h"
// Member `valid_flags`
...
static rosidl_typesupport_introspection_c__MessageMember microstrain_inertial_msgs__msg__MipGpsTimestamp__rosidl_typesupport_introspection_c__MipGpsTimestamp_message_member_array[3] = {
  {
    "tow",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(microstrain_inertial_msgs__msg__MipGpsTimestamp, valid_flags),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, microstrain_inertial_msgs, msg, MipGpsTimestamp)() {
  microstrain_inertial_msgs__msg__MipGpsTimestamp__rosidl_typesupport_introspection_c__MipGpsTimestamp_message_member_array[2].members_ =
